   ...
   <nav class="navbar navbar-expand-lg fixed-top navbar-transparent " color-on-scroll="100">
     <div class="container">
       ...
       <div class="collapse navbar-collapse justify-content-end" id="navigation">
         ...
         <ul class="navbar-nav">
           <li class="nav-item">
             <a class="nav-link" href="register-page.php">Don't have an account ? create now</a>
           </li>
         </ul>
       </div>
     </div>
...
<!-- Password -->
                  ...
                  <div class="text-center py-3">
                    <button type="submit" class="btn btn-info btn-round btn-lg" name="login">Masuk</button>
                  </div>
                </form>
<!-- Form End -->
